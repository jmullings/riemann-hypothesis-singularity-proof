...
RECOMMENDATION:
  The 9D geometry provides COMPLEMENTARY information to Hardy Z.
  Use both layers for optimal discrimination.
  Conjecture V: 9D invariants sharpen Hardy Z with independent geometry.
""")
    print("=" * 70)
