# SIGMA_08 Trinity Validation Report

**Script:** `EXECUTION/EQ8_EXPLICIT_FORMULA_SIGMA_BOUND.py`
**Category:** SIGMA  **Description:** EQ8 Explicit Formula sigma-Bound
...
| II  | sigma=1/2 Identified | PASS | indicators=5 |
